...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(140, 70, 494, 41));
        ...
        ultrasonicTextEdit = new QTextEdit(widget);
        ultrasonicTextEdit->setObjectName(QStringLiteral("ultrasonicTextEdit"));

        horizontalLayout->addWidget(ultrasonicTextEdit);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "Ultrasonic Distance Measurement", Q_NULLPTR));
